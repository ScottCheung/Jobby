...
# Your legal name
first_name = "Xianzhe"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = ""            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Zhang"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "0434344292"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Sydney, New South Wales"                  # Los Angeles, San Francisco, etc.
'''
...
gender = "Male"
gender_identity ="Male"                  # "Male", "Female", "Other", "Decline" or ""
