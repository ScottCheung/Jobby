...
7. Run `worker/runAiBot.py` and see the magic happen.
8. To run the Applied Jobs history UI, run `backend/app.py` and open web browser on `http://localhost:5000`.
...
```python
##> ------ Scott Cheung : godsscion - Feature ------
