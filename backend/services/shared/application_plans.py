...
def plan_from_dict(payload: Mapping[str, Any]) -> ApplicationPlan:
    ...
    candidate = JobCandidate(
        ...
        priority_score=candidate_payload.get("priority_score"),
        recency_factor=candidate_payload.get("recency_factor"),
        skill_score=candidate_payload.get("skill_score"),
        title_score=candidate_payload.get("title_score"),
        title_confidence=candidate_payload.get("title_confidence"),
        exp_score=candidate_payload.get("exp_score"),
