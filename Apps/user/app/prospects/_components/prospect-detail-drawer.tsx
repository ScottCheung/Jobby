    ...
    <div className='relative flex h-full w-full flex-col justify-between bg-panel p-6 overflow-y-auto'>
      ...
      <div>
          ...
          <div className='flex items-center gap-2'>
            <button
              ...
              className={`rounded-lg px-2.5 py-1 text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer ${
                ...
                : 'text-ink-primary hover:bg-background-secondary'
              }`}
            >
            ...
            <div className='grid grid-cols-2 gap-3'>
              <div>
                ...
                <input
                  ...
                  className='w-full rounded-xl bg-background p-2.5 text-xs text-ink-primary'
                />
              </div>
              <div>
                <label className='font-semibold text-ink-primary block mb-1'>
            ...
            <div className='grid grid-cols-2 gap-3'>
              <div>
                ...
                <select
                  ...
                  className='w-full rounded-xl bg-background p-2 text-xs text-ink-primary'
                >
              ...
              <div>
                ...
                <input
                  ...
                  className='w-full rounded-xl bg-background p-2 text-xs text-ink-primary font-bold'
                />
              </div>
            </div>
        ...
        : /* View Mode */
          <>
            {/* Profile Info Card */}
            <div className='mt-5 rounded-2xl bg-background-secondary/40 p-4 flex flex-col gap-3'>
            ...
            {activeJobTitle && (
              <div className='mt-4 rounded-2xl bg-blue-500/10 p-4 flex flex-col gap-2'>
            ...
            <div className='mt-4 rounded-2xl bg-primary/5 p-4 space-y-3 text-xs'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-3 pt-1'>
                {[
                  ...
                  <div
                    key={m.label}
                    className='space-y-1 bg-background/60 p-2.5 rounded-xl'
                  >
            ...
            <div className='mt-4 rounded-2xl bg-background/50 p-4 flex flex-col gap-2 text-xs'>
              <span className='font-bold text-ink-primary flex items-center gap-1.5 uppercase tracking-wider text-[11px]'>
        ...
        <div className='mt-4 rounded-2xl bg-background/50 p-4 flex flex-col gap-3'>
          <div className='flex items-center justify-between text-xs'>
            ...
            <button
              ...
              className='flex items-center gap-1.5 rounded-lg bg-background px-2.5 py-1 text-[11px] font-medium text-ink-primary hover:bg-background-secondary transition-colors cursor-pointer'
            >
              {copiedPitch ?
                <>
          ...
          <textarea
            ...
            value={pitchText}
            rows={5}
            className='w-full rounded-xl bg-background p-3 text-xs text-ink-primary font-mono leading-relaxed focus:outline-hidden no-scrollbar'
          />
        </div>
        ...
        <div className='mt-4 flex flex-col gap-3 text-xs'>
          <div>
            ...
            <select
              ...
              className='w-full rounded-xl bg-background p-2.5 text-xs font-medium text-ink-primary focus:outline-hidden focus:ring-2 focus:ring-primary/40 cursor-pointer'
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className='w-full rounded-xl bg-background p-3 text-xs text-ink-primary focus:outline-hidden focus:ring-2 focus:ring-primary/40'
            />
          </div>
        </div>
      </div>
      ...
      <div className='mt-6 pt-4 flex items-center justify-between gap-3 shrink-0'>
        <button
          onClick={handleDelete}
          disabled={isDeleting}
          className='flex items-center gap-1.5 rounded-xl bg-red-500/10 px-3.5 py-2.5 text-xs font-semibold text-red-600 dark:text-red-400 hover:bg-red-500/20 transition-colors disabled:opacity-50 cursor-pointer'
        >
        ...
        <div className='flex items-center gap-2'>
          <button
            onClick={onClose}
            className='rounded-xl bg-background px-4 py-2.5 text-xs font-semibold text-ink-primary hover:bg-background-secondary transition-colors cursor-pointer'
          >
            Cancel
          </button>
          <button
