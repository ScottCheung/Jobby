...
export default function AutomationPanel() {
  ...
  const PLATFORMS: Array<{
  ...
  }> = [
    {
      ...
      brandHoverClass:
        'hover:border-[#0a66c2]/45 dark:hover:border-[#0a66c2]/60 hover:bg-[#0a66c2]/5 dark:hover:bg-[#0a66c2]/10',
    ...
    },
    {
      ...
      brandHoverClass:
        'hover:border-[#0d3880]/45 dark:hover:border-[#0d3880]/60 hover:bg-[#0d3880]/5 dark:hover:bg-[#0d3880]/10',
                        ...
                        {isRunning && (
                          <>
                            <span className='text-[11px] font-bold text-green-500 group-hover/btn:hidden flex items-center gap-1'>
                              <span className='w-1.5 h-1.5 rounded-full bg-green-500 animate-text-shimmer-primary animate-text-shimmer' />{' '}
                              Running
                            </span>
