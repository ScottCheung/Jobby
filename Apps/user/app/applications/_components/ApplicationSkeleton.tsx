...
export function ApplicationSkeleton({ style }: ApplicationSkeletonProps) {
  return (
    <div
      style={style}
      className='grid grid-cols-[minmax(0,3fr)_minmax(0,2fr)_minmax(0,2fr)_minmax(0,1.5fr)_minmax(0,2fr)] items-center px-4 animate-pulse'
    >
      <div className='pr-4'>
