    ...
    <div className='panel-xl col'>
      ...
      <div className='panel-sm'>
        <div className='flex items-center justify-between gap-3'>
          <span className='body-md text-ink-secondary'>Browser Status</span>
          {sessionStatus?.isRunning ?
            <span className='label-sm inline-flex items-center gap-1.5 rounded-full border border-success/20 bg-success/10 px-2.5 py-0.5 text-success'>
              Open
            </span>
      ...
      <div className='grid grid-cols-1 gap-3'>
        <button
          ...
          className='label w-full py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 transition-all shadow-md active:scale-98 cursor-pointer flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed'
        >
        ...
        <button
          ...
          className='label w-full py-2.5 rounded-xl bg-ink-secondary/10 hover:bg-ink-secondary/20 transition active:scale-98 cursor-pointer flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed'
        >
