      ...
      <div className="relative bg-panel border border-border dark:border-border rounded-3xl p-8 max-w-sm w-full shadow-2xl flex flex-col items-center text-center animate-in zoom-in-95 duration-300">
        ...
        <div className="grid grid-cols-2 gap-4 w-full mb-8">
          <div className="flex flex-col items-center p-4 bg-amber-500/10 rounded-2xl border border-amber-500/20">
            ...
            <span className="title-page text-amber-600 dark:text-amber-500">{summary.current_streak}</span>
            <span className="label-sm text-amber-600/80 uppercase mt-1">Day Streak</span>
          </div>
          ...
          <div className="flex flex-col items-center p-4 bg-primary/10 rounded-2xl border border-primary/20">
            ...
            <span className="title-page text-primary">+{summary.xp_gained_today}</span>
            <span className="label-sm text-primary/80 uppercase mt-1">XP Gained</span>
          </div>
          ...
          <div className="flex flex-col items-center p-4 bg-yellow-500/10 rounded-2xl border border-yellow-500/20 col-span-2">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="title-card text-yellow-600 dark:text-yellow-500">+{summary.coins_gained_today} Coins</span>
            </div>
            <span className="label-sm text-yellow-600/80">Keep it up to unlock more rewards!</span>
          </div>
        </div>
