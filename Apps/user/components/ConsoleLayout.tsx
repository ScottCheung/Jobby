            ...
            {!isCollapsed && (
              <button
                ...
                className={cn(
                  ...
                  isDesktopApp ?
                    desktopBotIsStarting ? 'text-zinc-400'
                    : desktopBotIsStopping ? 'text-zinc-400'
                    : desktopBotIsActive ?
              ...
              >
                {(
                  isDesktopApp && (desktopBotIsStarting || desktopBotIsStopping)
                ) ?
                  ...
                  <StaggerItem yOffset={20}>
                    <CardWithNorth key={item.label} title={item.label}>
                      <div className='flex items-start justify-between relative'>
                        <div
                          className={cn(
                            'absolute -top-16 -right-2 z-50 p-6 rounded-full backdrop-blur-[9px]',
                            item.bgColor,
                            item.borderColor,
                          )}
                        >
